...
public class Picture extends SimplePicture 
{
  ...
  public void myCollage()
  {
    ...
    Picture flowerAllBlue = new Picture(flower1);
    flowerAllBlue.keepOnlyBlue();
    this.copy(flowerNoBlue,300,0);
    this.copy(flowerGrey,400,0);
    this.copy(flowerAllBlue,500,0);
    this.mirrorVertical();
  ...
  public static void main(String[] args) 
  {
    ...
    beach.explore();
    beach.edgeDetection(6);
    beach.explore();
    //Picture thing = new Picture("7inX95in.jpg");
    //thing.myCollage();
  }
